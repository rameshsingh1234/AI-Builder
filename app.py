...
with col1:
    url = st.text_input("Enter URL (include http/https):", placeholder="https://example.com")

with col2:
    st.markdown("<div style='height: 1.3em'></div>", unsafe_allow_html=True)
    generate = st.button("Generate Test Cases", use_container_width=True)
